...
# Write version to app_skel/__init__.py
...
try:
    ...
    subprocess.call(["git", "commit", "-m \"Updating app_skel/__init__.py to "+\
                    "version - {}".format(version_git)])
    subprocess.call(["git", "push"])
    subprocess.call(["git", "tag", "-a", version_git, "-m", "Updating app_skel to "+\
                    "version - {}".format(version_git)])
